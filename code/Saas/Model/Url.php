 ...
 * @method Cm_Saas_Model_Url setNoSecret(bool $value)
 */
class Cm_Saas_Model_Url extends Mage_Core_Model_Url
{

    const XML_PATH_SECURE_IN_SAAS        = 'saas/security/use_secure';
    const XML_PATH_USE_SECRET_KEY        = 'saas/security/use_secret_key';
    ...
    public function getSecure()
    {
        ...
        return Mage::getStoreConfigFlag(self::XML_PATH_SECURE_IN_SAAS);
    }
    ...
    {
        return Mage::getStoreConfigFlag(self::XML_PATH_USE_SECRET_KEY) && !$this->getNoSecret();
    }
