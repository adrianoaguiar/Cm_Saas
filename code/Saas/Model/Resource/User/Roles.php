 ...
 * @package     Cm_Saas
 */
class Cm_Saas_Model_Resource_User_Roles extends Mage_Core_Model_Resource_Db_Abstract
{
    /**
     * Users table
     *
    ...
    protected function _construct()
    {
        ...
        $this->_usersTable = $this->getTable('saas/user');
        $this->_ruleTable = $this->getTable('saas/user_rule');
    }
     ...
     * @return Cm_Saas_Model_Resource_User_Roles
     */
     ...
     * Get role users
     *
     * @param Cm_Saas_Model_User_Roles $role
     * @return array|false
     */
    public function getRoleUsers(Cm_Saas_Model_User_Roles $role)
    {
     ...
     * @return bool
     */
    private function _updateRoleUsersAcl(Cm_Saas_Model_User_Roles $role)
    {
