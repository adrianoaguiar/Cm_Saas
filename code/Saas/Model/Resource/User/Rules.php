 ...
 * @package     Cm_Saas
 */
class Cm_Saas_Model_Resource_User_Rules extends Mage_Core_Model_Resource_Db_Abstract
{
    /**
     * Define main table
     *
    ...
    {
        $this->_init('saas/user_rule', 'rule_id');
    }

    /**
     * Save ACL resources
     *
     * @param Cm_Saas_Model_User_Rules $rule
     */
    public function saveRel(Cm_Saas_Model_User_Rules $rule)
    {
        try {
            ...
            if ($postedResources) {
                ...
                if ($postedResources === array('all')) {
                    ...
                    foreach (Mage::getModel('saas/user_roles')->getResourcesList2D() as $index => $resName) {
