 ...
 * Admin Roles Model
 *
 * @method Cm_Saas_Model_Resource_Roles _getResource()
 * @method Cm_Saas_Model_Resource_Roles getResource()
 * @method int getParentId()
 * @method Cm_Saas_Model_User_Roles setParentId(int $value)
 * @method int getTreeLevel()
 * @method Cm_Saas_Model_User_Roles setTreeLevel(int $value)
 * @method int getSortOrder()
 * @method Cm_Saas_Model_User_Roles setSortOrder(int $value)
 * @method string getRoleType()
 * @method Cm_Saas_Model_User_Roles setRoleType(string $value)
 * @method int getUserId()
 * @method Cm_Saas_Model_User_Roles setUserId(int $value)
 * @method string getRoleName()
 * @method Cm_Saas_Model_User_Roles setRoleName(string $value)
 *
 * @category    Cm
 * @package     Cm_Saas
 */
class Cm_Saas_Model_User_Roles extends Mage_Core_Model_Abstract
{
    /**
     * @var string
     */
    ...
    {
        $this->_init('saas/user_roles');
    }

    /**
     * Update object into database
     *
     * @return Cm_Saas_Model_User_Roles
     */
     ...
     *
     * @return Cm_Saas_Model_Resource_Roles_User_Collection
     */
    public function getUsersCollection()
    {
        return Mage::getResourceModel('saas/user_roles_user_collection');
    }
        ...
        $parentName = null, $level = 0, $represent2Darray = null, $rawNodes = false, $module = 'adminhtml')
    {
        static $result;
        if (is_null($resource)) {
            $resource = Mage::getSingleton('saas/user_config')->getAdminhtmlConfig()->getNode('acl/resources');
            $resourceName = null;
            $level = -1;
        } else {
