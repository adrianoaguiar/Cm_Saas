 ...
 * Admin user model
 *
 * @method Cm_Saas_Model_Resource_User _getResource()
 * @method Cm_Saas_Model_Resource_User getResource()
 * @method string getFirstname()
 * @method Cm_Saas_Model_User setFirstname(string $value)
 * @method string getLastname()
 * @method Cm_Saas_Model_User setLastname(string $value)
 * @method string getEmail()
 * @method Cm_Saas_Model_User setEmail(string $value)
 * @method string getUsername()
 * @method Cm_Saas_Model_User setUsername(string $value)
 * @method string getPassword()
 * @method Cm_Saas_Model_User setPassword(string $value)
 * @method string getCreated()
 * @method Cm_Saas_Model_User setCreated(string $value)
 * @method string getModified()
 * @method Cm_Saas_Model_User setModified(string $value)
 * @method string getLogdate()
 * @method Cm_Saas_Model_User setLogdate(string $value)
 * @method int getLognum()
 * @method Cm_Saas_Model_User setLognum(int $value)
 * @method int getReloadAclFlag()
 * @method Cm_Saas_Model_User setReloadAclFlag(int $value)
 * @method int getIsActive()
 * @method Cm_Saas_Model_User setIsActive(int $value)
 * @method string getExtra()
 * @method Cm_Saas_Model_User setExtra(string $value)
 *
 * @category    Cm
 * @package     Cm_Saas
 */
class Cm_Saas_Model_User extends Mage_Core_Model_Abstract
{
    /**#@+
     * Configuration paths for email templates and identities
     */
    const XML_PATH_FORGOT_EMAIL_TEMPLATE    = 'saas/user_emails/forgot_email_template';
    const XML_PATH_FORGOT_EMAIL_IDENTITY    = 'saas/user_emails/forgot_email_identity';
    const XML_PATH_STARTUP_PAGE             = 'saas/user_startup/page';
    /**#@-*/
    ...
    {
        $this->_init('saas/user');
    }

    /**
     * Processing data before model save
     *
     * @return Cm_Saas_Model_User
     */
     ...
     *
     * @return Cm_Saas_Model_Roles
     */
    public function getRole()
    {
        if (null === $this->_role) {
            $this->_role = Mage::getModel('saas/user_roles');
            $roles = $this->getRoles();
     ...
     *
     * @return Cm_Saas_Model_Resource_User_Collection
     */
    public function getCollection() {
        return Mage::getResourceModel('saas/user_collection');
    }
    ...
    {
        $config = Mage::getStoreConfigFlag('saas/user_security/use_case_sensitive_login');
        $result = false;
    ...
    {
        if ($parent == null) {
            $parent = Mage::getSingleton('saas/user_config')->getAdminhtmlConfig()->getNode('menu');
        }
        foreach ($parent->children() as $childName => $child) {
            $aclResource = 'saas/user_' . $path . $childName;
            if (Mage::getSingleton('saas/session')->isAllowed($aclResource)) {
                if (!$child->children) {
    ...
    public function getStartupPageUrl()
    {
        ...
        $aclResource = 'saas/user_' . $startupPage;
        if (Mage::getSingleton('saas/session')->isAllowed($aclResource)) {
            $nodePath = 'menu/' . join('/children/', explode('/', $startupPage)) . '/action';
            $url = Mage::getSingleton('saas/user_config')->getAdminhtmlConfig()->getNode($nodePath);
            if ($url) {
                return $url;
            }
        }
