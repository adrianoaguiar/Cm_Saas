...
$table = $installer->getConnection()
    ->newTable($installer->getTable('saas/user_assert'))
...
/**
 * Create table 'saas/user_role'
 */
$table = $installer->getConnection()
    ->newTable($installer->getTable('saas/user_role'))
    ...
    ->addIndex($installer->getIdxName('saas/user_role', array('parent_id', 'sort_order')),
        array('parent_id', 'sort_order'))
    ->addIndex($installer->getIdxName('saas/user_role', array('tree_level')),
        array('tree_level'))
    ->setComment('Admin Role Table');
$installer->getConnection()->createTable($table);

/**
 * Create table 'saas/user_rule'
 */
$table = $installer->getConnection()
    ->newTable($installer->getTable('saas/user_rule'))
    ...
    ->addIndex($installer->getIdxName('saas/user_rule', array('resource_id', 'role_id')),
        array('resource_id', 'role_id'))
    ->addIndex($installer->getIdxName('saas/user_rule', array('role_id', 'resource_id')),
        array('role_id', 'resource_id'))
    ->addForeignKey($installer->getFkName('saas/user_rule', 'role_id', 'saas/user_role', 'role_id'),
        'role_id', $installer->getTable('saas/user_role'), 'role_id',
 ...
 */
$table = $installer->getConnection()
    ->newTable($installer->getTable('saas/user'))
    ->addColumn('user_id', Varien_Db_Ddl_Table::TYPE_INTEGER, null, array(
        'identity'  => true,
        'unsigned'  => true,
        'nullable'  => false,
    ...
    ->addIndex($installer->getIdxName('saas/user', array('username'), Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE),
...
$installer->getConnection()->addColumn($installer->getTable('saas/user'), 'rp_token', array(
...
$installer->getConnection()->addColumn($installer->getTable('saas/user'), 'rp_token_created_at', array(
